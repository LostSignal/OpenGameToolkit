...
namespace OGT.Networking
{
    ...
    {
        private static readonly OGTLogger Logger = new("LiteNetLib");
        ...
        bool IServerTransportLayer.PrintDebugOutput => this.printDebugOutput;
        ...
        void IServerTransportLayer.Start(int port, bool pringDebugOutput)
        {
            if (this.server != null)
            {
                this.Shutdown();
            ...
            this.printDebugOutput = pringDebugOutput;
        }
        ...
        void INetEventListener.OnPeerConnected(NetPeer peer)
        {
            ...
            {
                Logger.Log("ServerTransport: OnPeerConnected");
            }
        ...
        void INetEventListener.OnPeerDisconnected(NetPeer peer, DisconnectInfo disconnectInfo)
        {
            if (this.printDebugOutput)
            {
                Logger.Log("ServerTransport: OnPeerDisconnected");
            }
        ...
        void INetEventListener.OnConnectionRequest(ConnectionRequest request)
        {
            if (this.printDebugOutput)
            {
                Logger.Log("ServerTransport: OnConnectionRequest");
            }

            request.AcceptIfKey("e1890f82786146bba503b127f1e4e0f6");
        }
        ...
        void INetEventListener.OnNetworkError(IPEndPoint endPoint, SocketError socketError)
        {
            if (this.printDebugOutput)
            {
                Logger.Log("ServerTransport: OnNetworkError");
            }
        }
        ...
        void INetEventListener.OnNetworkReceiveUnconnected(IPEndPoint remoteEndPoint, NetPacketReader reader, UnconnectedMessageType messageType)
        {
            if (this.printDebugOutput)
            {
                Logger.Log("ServerTransport: OnNetworkReceiveUnconnected");
            }
        }
