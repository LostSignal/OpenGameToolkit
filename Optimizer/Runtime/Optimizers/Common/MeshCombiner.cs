...
namespace OGT
{
    ...
    public static class MeshCombiner
    {
        ...
        public static void DeleteEmptyOrDisabledGameObjects(Transform childTransform, bool isRoot = true)
        {
            ...
            {
                Logger.Log("LOD1", childTransform);
            }
        ...
        public static void CreateLOD(OptimizedLOD optimizedLOD)
        {
            ...
            EditorUtil.GetOrAddComponent<MeshFilter>(optimizedLOD);
            EditorUtil.GetOrAddComponent<MeshRenderer>(optimizedLOD);
            EditorUtil.GetOrAddComponent<OptimizedLOD>(optimizedLOD);
            ...
            int lod = -1)
        {
            ...
            EditorUtil.GetOrAddComponent<MeshFilter>(lodTransform.gameObject);
            EditorUtil.GetOrAddComponent<MeshRenderer>(lodTransform.gameObject);
            EditorUtil.GetOrAddComponent<OptimizedLOD>(lodTransform.gameObject);
            ...
            void GenerateLODGroup()
            {
                ...
                var lodGroup = EditorUtil.GetOrAddComponent<LODGroup>(lodsTransform.gameObject);
        ...
        {
            var finalMeshFilter = EditorUtil.GetOrAddComponent<MeshFilter>(transform);
            var finalMeshRenderer = EditorUtil.GetOrAddComponent<MeshRenderer>(transform);
            ...
            {
                Logger.LogError("SOMETHING WHEN HORRIBLY WRONG");
                return;
            }
        ...
        ////             else
        ////             {
        ////                 Lost.Logger.Log("Initializing failed!");
        ////             }
        ////         }
        ////
        ////         return null;
        ...
        ////     else
        ////     {
        ////         Lost.Logger.LogError($"Unknown Mesh Simplifier {lodSettings.Simplifier} found!");
        ////         return null;
        ////     }
        ////     #else
        ////
