...
namespace OGT
{
    ...
    public class GroundMeshDecal : GameBehavior, IUpdate, IValidate
    {
...
#pragma warning restore 0649
        ...
        {
            this.EditorGetComponent(ref this.meshFilter);

            report.AssertNotNull(this, this.meshFilter, nameof(this.meshFilter));
        }
