...
namespace OGT.PlayFab
{
    ...
    public static class IAPCatalogExporter
    {
        ...
        [MenuItem("Tools/OGT/Work In Progress/PlayFab/Export Google Play CSV", priority = MenuItemPriorities.WorkInProgress + 0)]
        public static void ExportGooglePlayCatalog()
        {
            ...
            Logger.Log("Catalog Count = " + catalogItems?.Result?.Catalog?.Count);
